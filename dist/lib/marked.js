...
;(function() {
	...
	Lexer.prototype.token = function(src, top) {
		...
		while (src) {
			...
			// swagger
			if (cap = this.rules.swagger.exec(src)) {
				src = src.substring(cap[0].length);
				this.tokens.push({
					type: 'swagger',
					depth: cap[1].length,
	...
	Renderer.prototype.swagger = function(text, level, raw, options) {
		return '<div style="margin-left:0" spec="'
				+ text
				+ '" id="swagger-ui-container'
				+ '" name="swagger-ui-container'
				+ '" api-explorer="true">Swagger to go in here</div>\n';
	};
